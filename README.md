...
**私人灵感仓库 + 思考引擎** — 本地 Markdown 工作区承载碎片与计划，右侧 AI（Gemini / Claude / CodeBuddy 等 CLI）读写同一文件夹；`/today`、`/graduate` 等命令把成品写回笔记，而不是消失在聊天里。

开源桌面应用（Electron）。**产品代码、工作区模版与构建配置均在 [`metamates-app/`](metamates-app/) 目录。**
...
| [metamates-app/docs/OPEN_SOURCE.md](metamates-app/docs/OPEN_SOURCE.md) | 开源文件清单 |
...
- **当前基线：0.1.0**（2026-07-08）— 此前的内测号（v0.x-beta、`VERSION.md`）已作废。
