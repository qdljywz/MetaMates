...
> **私人灵感仓库** — 本地 Markdown 文件夹，由 [Metamates](https://github.com/metamates/metamates-app) 桌面应用读写。碎片、日记、剪藏先放这里；**右侧引擎**（AI 对话 + slash 命令）读过仓库后，把计划与洞察写回这些文件。
...
**工作区模板版本**：1.3 · 与 Metamates 桌面应用同步 · 2026-06-22
