...
const file = path.join(path.dirname(fileURLToPath(import.meta.url)), '..', 'src/test/acpSpawn.test.ts')
const source = `import { describe, expect, it, vi } from 'vitest'
...
console.log('rewrote acpSpawn.test.ts with shellEnv mock')
